    ...
    <div class="main">
        ...
        <div class="infoContainer">
           <div class="devinfo">
            ...
            <div class="about">HTML| CSS| JavaScript| C++| C</div>
            <div class="about">Python| React| SQL</div>
            <div class="buttons">
                <a href="/Portfolio/Harshit.pdf" target="blank"> <button class="btn"> Download CV</button></a>
                <a href="/Portfolio/contact.php"><button class="btn" >Contact me </button></a>
            </div>
           </div>
           <div class="manPic"><img src="p2.jpg" alt="Loading"></div>
